...
enum PalmLengthStatus {
    ...
    {
        return [
            self::INACTIVE => trans('admin.palm-length.inactive'),
            self::ACTIVE => trans('admin.palm-length.active')
        ];
    }
    ...
    public static function getStatusListWithClass(): array
    {
        return [
            self::INACTIVE => [
                "value" => self::INACTIVE,
                "name" => trans('admin.palm-length.inactive'),
                "class" => "badge badge-soft-danger text-uppercase"
            ],
            self::ACTIVE => [
                "value" => self::ACTIVE,
                "name" => trans('admin.palm-length.active'),
