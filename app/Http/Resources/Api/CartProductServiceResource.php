...
class CartProductServiceResource extends JsonResource
{
    private $wallets ;
    ...
    public function toArray($request)
    {
        ...
        // $cartProduct = CartProduct::where('cart_id',$this->cart_id)->first();
        return [
            'id' => $this->id,
            'city' => $cart->city ? ['id' => $cart->city?->id , 'name' => $cart->city?->name, 'area_id' => $cart->city?->area_id] : null,
