...
class TransactionCanceled implements ShouldQueue
{
    ...
    public function handle()
    {
        try {
            ...
            $clientMessage = ClientMessage::messageFor(ClientMessageEnum::CanceledTransaction)->first();
            ...
            Log::channel("customer-sms-errors")->error("Exception in TransactionCanceled: ". $e->getMessage());
        }
    }
}
