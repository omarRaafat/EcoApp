...
class TransactionInvoice implements ShouldQueue
{
    ...
    public function handle()
    {
        try {
            ...
            $msg = "::var_client_name::،\n تم توصيل طلبك رقم ::var_order_id::";

            $clientMessage = ClientMessage::messageFor(ClientMessageEnum::CompleteOrder)->first();
            ...
            Log::channel("customer-sms-errors")->error("Exception in TransactionInvoice: ". $e->getMessage());
        }
    }
}
