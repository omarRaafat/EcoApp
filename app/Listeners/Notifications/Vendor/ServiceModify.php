...
class ServiceModify
{
     ...
     * Handle the event.
     *
     * @param  \App\Events\Admin\Service\Modify  $event
     * @return void
     */
    public function handle(Modify $event)
    {
        try {
            $title = __('notifications.vendor.service.modify.title', [], "ar") . $event->service->name;
            $message = __('notifications.vendor.service.modify.message', [], "ar");
