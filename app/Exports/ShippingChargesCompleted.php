...
class ShippingChargesCompleted implements FromCollection, WithMapping, WithHeadings, WithColumnFormatting, WithColumnWidths, WithEvents
{
    use Exportable;
    ...
    public function map($order): array
    {
        return [
            ...
            $order->created_at ? date('d-m-Y, H:i', strtotime($order->created_at)) : "N/A",
            $order->pickup_at ? date('d-m-Y, H:i', strtotime($order->pickup_at)) : "N/A",
        ];
    }
