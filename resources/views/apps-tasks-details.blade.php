                    ...
                    <ul class="list-unstyled vstack gap-3 mb-0">
                        <li>
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1 ms-2">
                                    <h6 class="mb-1"><a href="{{URL::asset('/pages-profile')}}" class="link-secondary">Tonya
                                            Noble</a></h6>
                        ...
                        <li>
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1 ms-2">
                                    <h6 class="mb-1"><a href="{{URL::asset('/pages-profile')}}" class="link-secondary">Thomas
                                            Taylor</a></h6>
                        ...
                        <li>
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1 ms-2">
                                    <h6 class="mb-1"><a href="{{URL::asset('/pages-profile')}}" class="link-secondary">Nancy
                                            Martino</a></h6>
                            ...
                            <div data-simplebar style="height: 508px;" class="px-3 mx-n3 mb-2">
                                <div class="d-flex mb-4">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        <h5 class="fs-13"><a href="{{URL::asset('/pages-profile')}}">Joseph Parker</a> <small
                                        ...
                                        <div class="d-flex mt-4">
                                            ...
                                            <div class="flex-grow-1 ms-3">
                                                <h5 class="fs-13"><a href="{{URL::asset('/pages-profile')}}">Tonya Noble</a>
                                ...
                                <div class="d-flex mb-4">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        <h5 class="fs-13"><a href="{{URL::asset('/pages-profile')}}">Thomas Taylor</a> <small
                                ...
                                <div class="d-flex">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        <h5 class="fs-13"><a href="{{URL::asset('/pages-profile')}}">Tonya Noble</a> <small
                                        ...
                                        <div class="d-flex mt-4">
                                            ...
                                            <div class="flex-grow-1 ms-3">
                                                <h5 class="fs-13"><a href="{{URL::asset('/pages-profile')}}">Nancy Martino</a>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <img src="{{ URL::asset('assets/images/users/avatar-10.jpg') }}" alt=""
                                                        class="rounded-circle avatar-xxs">
                                                    <div class="flex-grow-1 ms-2">
                                                        <a href="{{URL::asset('/pages-profile')}}" class="fw-medium link-secondary">Tonya
                                                            Noble</a>
                                                    </div>
                                                </div>
                                            </td>
