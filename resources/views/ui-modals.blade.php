                            ...
                            <div class="modal-content">
                                <div class="modal-body text-center p-5">
                                    ...
                                    <div class="mt-2">
                                        ...
                                        <p class="text-muted fs-15 mb-4">Successful transaction is the status of operation whose result is the payment of the amount paid by the customer in favor of the vendor.</p>
                                        <div class="hstack gap-2 justify-content-center">
