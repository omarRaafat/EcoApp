                        ...
                        <div class="table-responsive table-card mb-1">
                            <table class="table table-nowrap align-middle">
                                ...
                                @foreach($collection ?? [] as $row)
                                    @include("vendor.reports.vendor-order-row", ['row' => $row])
                                @endforeach
...
@section('script')
    ...
    <script>
        function openPrint() {
            ...
            window.open(`{{ route('vendor.reports.orders-report.print') }}?vendor=${vendor}&from=${from}&to=${to}`, "_blank")
        }
        ...
        function openExcel() {
            ...
            const from = $("input[name=from]").val()
            const to = $("input[name=to]").val()
            window.open(`{{ route('vendor.reports.orders-report.excel') }}?vendor=${vendor}&from=${from}&to=${to}`, "_blank")
        }
    </script>
@endsection
