                ...
                <div class="card-body border border-dashed border-end-0 border-start-0">
                    <form>
                        <div class="row g-3">
                            ...
                            <div class="col-xxl-2 col-sm-4">
                                <div>
                                    <select class="form-control" data-choices data-choices-search-false
                                        ...
                                        <option @selected($request->get('is_active') == '1') value="1">@lang("admin.products.active")</option>
                                        <option @selected($request->get('is_active') == '0') value="0">@lang("admin.products.inactive")</option>
                                    </select>
                                </div>
                            </div>
                            <!--end col-->
                            <div class="col-xxl-2 col-sm-4">
                                <div>
                                    <select class="form-control" data-choices data-choices-search-false
                                        ...
                                        <option value="all" selected>@lang("admin.products.all")</option>
                                        <option @selected($request->get('type') == 'temp') value="temp">@lang("admin.products.updated_products")</option>
                                        <option @selected($request->get('type') == 'pending') value="pending">@lang("admin.products.pending_products")</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-xxl-1 col-sm-4">
                                <div>
                                    <a href="{{ route('vendor.products.export' , ['search' => request()->get('search') , 'created_date' => request()->get('created_date') ,'is_active' => request()->get('is_active')  ,'type' => request()->get('type')   ]) }}" class="btn btn-primary"> تصدير Excel</a>
                                </div>
                            </div>
                            <!--end col-->
                        </div>
                                            ...
                                            <tr>
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        <div class="flex-shrink-0 me-3">
                                                            <div class="avatar-sm bg-light rounded p-1">
                                                                @if($product->square_image_temp && $product->square_image_temp != $product->square_image && $product?->status != 'accepted')
                                                                <img src="{{$product->square_image_temp }}" alt="" class="img-fluid d-block">
                                                ...
                                                <td>
                                                    <ul class="list-inline hstack gap-2 mb-0">
                                                        ...
                                                        {{-- <li class="list-inline-item" data-bs-toggle="tooltip"
                                                            data-bs-trigger="hover" data-bs-placement="top" title="@lang('admin.products.countries_prices')">
                                                            <a href="{{ route("vendor.products.country_prcies", $product->id) }}"
