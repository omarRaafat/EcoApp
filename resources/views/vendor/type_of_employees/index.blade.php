        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-content-center align-items-center">
                    <h5 class="card-title mb-0">@lang('translation.type_of_employees')</h5>
                    <a href="{{route('vendor.type-of-employees.create')}}" class="btn btn-success" id="addrole-btn"><i
                        class="ri-add-line align-bottom me-1"></i> @lang('translation.type_of_employee.create')</a>
                </div>
                <div class="card-body">
                    <table id="example" class="table table-bordered dt-responsive nowrap table-striped align-middle" style="width:100%">
                        <thead>
                            <tr>
                                <th scope="col">#</th>
                                <th scope="col">@lang('translation.type_of_employee.name')</th>
                                <th scope="col">@lang('translation.type_of_employee.level')</th>
                        ...
                        <tbody>
                            ...
                            @else
                                @foreach($data as $typeOfEmployee)
                                    <tr>
                                        <td>{{ $typeOfEmployee->id }}</td>
                                        <td>{{ $typeOfEmployee->name }}</td>
                                        <td>{{ $typeOfEmployee->level }}</td>
                                        <td>{{ date('d-m-Y h:i', strtotime($typeOfEmployee->created_at)) }}</td>
                                        <td>
                                            <ul class="list-inline hstack gap-2 mb-0">
                                                <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="View">
                                                    <a href="{{ route('vendor.type-of-employees.edit',$typeOfEmployee->id) }}" class="text-success d-inline-block">
                                                        <i class="ri-edit-box-fill fs-16"></i>
                                                    </a>
                                                </li>
                                                <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="View">
                                                    <a href="#" data-id='{{ $typeOfEmployee->id }}' data-bs-toggle="modal"
                                                        data-bs-target="#removeItemModal" onclick="showDeleteModal('{{ route('vendor.type-of-employees.destroy',$typeOfEmployee->id) }}')" class="text-danger d-inline-block">
