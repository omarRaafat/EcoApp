<form action="{{route('vendor.update-vendor')}}" method="POST" enctype="multipart/form-data">
    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            <div class="mb-3">
                <label for="firstnameInput" class="form-label">@lang('translation.vendor_owner_store_name')<span
        ...
        <div class="col-lg-6">
            <div class="mb-3">
                <label for="firstnameInput" class="form-label">@lang('translation.phone')<span
                        class="text-danger">*</span></label>
                <input type="text" class="form-control" name="store_name" id="firstnameInput" style="direction: ltr;"
        ...
        <div class="col-lg-6">
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="store_name" id="firstnameInput" style="direction: ltr;"
                       ...
                       value="{{$row->my_vendor->second_phone}}" disabled>
            </div>
        </div>
        ...
        <div class="col-md-6">
            ...
            <textarea disabled="disabled" readonly class="form-control" name="desc"
        ...
        <div class="col-md-6 mb-3">
            ...
            <div class="input-group">
                ...
                <input disabled="disabled" readonly type="text" class="form-control text-left"
                       value="{{ ltrim(strtoupper($row->my_vendor->ipan),'SA') }}">
        ...
        <div class="col-md-6 mb-3">
            ...
            <input disabled="disabled" readonly type="text" class="form-control" value="{{ $row->my_vendor->commercial_registration_no }}">
        </div>
        <div class="col-md-6 mb-3">
            <label for="inputAddress2" class="form-label">@lang('translation.crd_date')</label>
            <input disabled="disabled" readonly type="text" class="form-control"
                   value="{{ date('Y-m-d', strtotime($row->my_vendor->crd)) }}">
        </div>
