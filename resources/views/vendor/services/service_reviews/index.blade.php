...
@section('title')
@lang('translation.service_reviews')
@endsection
@section('css')
        ...
        <div class="card" id="orderList">
            <div class="card-header  border-0">
                <div class="d-flex align-items-center">
                    <!-- <h5 class="card-title mb-0 flex-grow-1">@lang('translation.service_reviews_list')</h5> -->
            ...
            <div class="card-body border border-dashed border-end-0 border-start-0">
                <form action="{{route('vendor.service-reviews')}}" >
                    <div class="row g-3">
                        ...
                        <div class="col-xxl-4 col-sm-4">
                            <div>
                                <select class="form-control" data-choices data-choices-search-true name="service_id" id="idService">
                                        <option value="all">@lang('translation.all_service_reviews')</option>
                                    @foreach($services as $service)
                                        <option value="{{$service->id}}" @if(isset($request) && $service->id == $request->service_id) selected @endif>{{$service->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-xxl-1 col-sm-4">
                            <div>
                                <a href="{{route('vendor.service-reviews')}}" type="reset" class="btn btn-secondary w-100"> <i class=" ri-loader-3-line me-1 align-bottom"></i>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title mb-0">@lang('translation.service_reviews')</h5>
                        </div>
                        <div class="card-body">
                            {{ $dataTable->table() }}
                        </div>
