...
@section('content')
    ...
    @component('components.breadcrumb')
        ...
        @endslot
        @slot('title')
            @lang('translation.update_warehouse')
        @endslot
    @endcomponent
            ...
            <div class="card" id="orderList">
                <div class="card-header  border-0">
                  ...
                  <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('vendor.warehouses.update', $warehouse->id) }}" method="post" class="form-steps" autocomplete="on">
                                @csrf
                                @method('put')
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <select name="shipping_type[]" multiple class="form-control" data-choices data-choices-removeItem>
                                                            @foreach($shipping_types ?? [] as $shipping_type)
                                                                <option value="{{ $shipping_type->id }}" @selected($warehouse->shippingTypes->where('id', $shipping_type->id)->isNotEmpty())>
                                                                    {{ $shipping_type->title }}
                                                                </option>
                                                            @endforeach
                                                        </select>
...
{{--                                                </div>--}}
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <select name="cities[]" class="form-select" dir="rtl" data-choices data-choices-removeItem>
                                                            @foreach($cities ?? [] as $city)
                                                                <option value="{{ $city->id }}" @selected($warehouse->cities->where('id', $city->id)->isNotEmpty())>
                                                                    {{ $city->name }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-4">
                                                    <div class="mb-3">
                                                        <label class="form-label" for="postcode">@lang('admin.postcode')</label>
                                                        <span class="text-danger">*</span>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 mb-3">
                                                    <label for="address" class="form-label">@lang('admin.full_address') -@lang('language.en')
                                                        <span class="text-danger">*</span>
                                                    </label>
...
{{--                                                <div class="col-md-12">--}}
{{--                                                    <div class="mb-3">--}}
{{--                                                        <input type="hidden" name="address[ar]" class="form-control"--}}
{{--                                                               value="{{ old("address.ar" , $warehouse->getTranslation('address','ar')) }}"--}}
{{--                                                               id="address"--}}
{{--                                                               placeholder="{{ trans('admin.warehouses.address') }}">--}}
{{--                                                        @error('address')--}}
{{--                                                        <span class="text-danger">{{ $message }}</span>--}}
{{--                                                        @enderror--}}
{{--                                                    </div>--}}
...
{{--                                            </div>--}}
                                            ...
                                            <div class="form-group">
                                                ...
                                                <span class="text-danger">*</span>
                                                <input type="text" id="address-input" name="address[ar]" class="form-control map-input" value="{{ $warehouse->getTranslation('address','ar') }}" placeholder="ابحث عن الموقع">
                                                <input type="hidden" name="latitude" id="address-latitude" value="{{ $warehouse->latitude }}" readonly="yes"/>
                                                <input type="hidden" name="longitude" id="address-longitude" value="{{ $warehouse->longitude }}" readonly="yes" />
                                            </div>
                                            @error('address.ar')
                                            <span class="text-danger">
                                                    @lang("admin.warehouses.validations.latitude_required")
