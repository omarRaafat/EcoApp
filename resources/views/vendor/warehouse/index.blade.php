        ...
        <div class="col-lg-12">
            <div class="card" id="warehouses">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-shrink-0">
                            <div class="d-flex gap-1 flex-wrap">
                                <a href="{{ route("vendor.warehouses.create") }}" class="btn btn-primary add-btn" id="create-btn">
                ...
                <div class="card-body border border-dashed border-end-0 border-start-0">
                    <form action="{{ route("vendor.warehouses.index") }}">
                        <div class="row g-3">
                            ...
                            <div class="col-xxl-1 col-sm-4">
                                <div>
                                    <a href="{{route('vendor.warehouses.index')}}" class="btn btn-info w-100"><i
                                            class="ri-equalizer-fill me-1 align-bottom"></i>
                            ...
                            <div class="col-xxl-1 col-sm-4">
                                <div>
                                    <a href="{{ route('vendor.warehouses.export' , ['search' => request()->get('search') , 'trans' => request()->get('trans')   ]) }}" class="btn btn-primary"> تصدير Excel</a>
                                </div>
                            </div>
                            <!--end col-->
                        </div>
                                            ...
                                            <td>
                                                ...
                                                <ul class="list-inline hstack gap-2 mb-0">
                                                    <li class="list-inline-item" data-bs-toggle="tooltip"
                                                        ...
                                                        <a href="{{ route("vendor.warehouses.show", $warehouse->id) }}"
                                                           class="text-primary d-inline-block">
                                                            <i class="ri-eye-fill fs-16"></i>
                                                        </a>
                                                    </li>
                                                    @if(!$warehouse->isWaitUpdated())
                                                    <li class="list-inline-item" data-bs-toggle="tooltip"
                                                        data-bs-trigger="hover" data-bs-placement="top" title="@lang('admin.warehouses.edit')">
                                                        <a href="{{ route("vendor.warehouses.edit", $warehouse->id) }}"
                                                           class="text-primary d-inline-block">
                                                    ...
                                                    <li class="list-inline-item" data-bs-toggle="tooltip"
                                                        ...
                                                        <a class="text-danger d-inline-block remove-item-btn"
                                                           data-bs-toggle="modal" href="#deletewarehouse-{{$warehouse->id}}">
                                                    ...
                                                    <div class="modal-body p-5 text-center">
                                                        ...
                                                        <div class="mt-4 text-center">
                                                            ...
                                                            <div class="hstack gap-2 justify-content-center remove">
                                                                ...
                                                                <form action="{{ route("vendor.warehouses.destroy", $warehouse->id) }}" method="post">
                                                                    @csrf
                                                                    @method("DELETE")
