            ...
            <div class="card-header border-0">
                <div class="row g-4">
                    <div class="col-sm-auto">
                        <div>
                            <a href="{{route('vendor.users.create')}}" class="btn btn-success" id="addproduct-btn"><i
                                    class="ri-add-line align-bottom me-1"></i> @lang('translation.create_user')</a>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="card-title mb-0">@lang('translation.users')</h5>
                                </div>
                                <div class="card-body">
                                    {{ $dataTable->table() }}
                                </div>
            ...
            <div class="modal-body">
                <div class="mt-2 text-center">
                    ...
                    <h4>@lang('translation.Are_you_sure')</h4>
                        <p class="text-muted mx-4 mb-0">@lang('translation.Are_you_sure_you_want_to_remove_this_user')</p>
                    </div>
                </div>
                <div class="d-flex gap-2 justify-content-center mt-4 mb-2">
                    <button type="button" class="btn w-sm btn-light" data-bs-dismiss="modal">@lang('translation.Close_back')</button>
                    <button type="button" class="btn w-sm btn-primary" id="delete-user"  onclick="deleteProduct($(this))">@lang('translation.yes_delete_it')</button>
                </div>
            </div>
...
<script>
    var product_id
    function showDeleteModal(product_data_id)
    {
