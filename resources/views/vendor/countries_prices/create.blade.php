    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card" id="orderList">
                <div class="card-body">
                    <form action="{{ route('vendor.products.prices.store',['id' => request('id')]) }}" method="post" class="form-steps"autocomplete="on">
                        @csrf
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" step=".01" min="0.01"
                                oninput="validatePrice(this)" name="price_with_vat"
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" step=".01" min="0.01"
                                oninput="validatePrice(this)" name="price_before_offer_in_halala"
