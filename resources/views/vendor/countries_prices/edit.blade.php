    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card" id="orderList">
                <div class="card-body">
                    <form action="{{ route('vendor.products.prices.update',['id' => $countryPrice->id]) }}" method="post" class="form-steps"autocomplete="on">
                        @csrf
                        @method('put')
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input value="{{ $countryPrice->priceBeforeInSar }}"
                                ...
                                aria-label="Price" aria-describedby="product-price-addon"
                                value="{{ $countryPrice->price_before_offer_in_halala }}">
