        ...
        <div class="col-lg-12">
            <div class="card" id="orderList">
                ...
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('admin.warehouses.store') }}" method="post" class="form-steps" autocomplete="on">
                                @csrf
                                @method('post')
                                    ...
                                    <div class="tab-pane fade active show" id="areas-arabic-info" role="tabpanel" aria-labelledby="areas-arabic-info-tab">
                                        <div>
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        <label class="form-label">@lang('admin.vendors')</label>
                                                        <span class="text-danger">*</span>
                                                        <select name="vendor_id" class="form-select" dir="rtl" data-choices data-choices-removeItem>
                                                            <option>@lang('translation.select-option')</option>
                                                            @foreach($vendors as $key => $vendor)
                                                                <option value="{{ $vendor->id }}"  @if($vendor->id == old('vendor_id')) selected @endif>
                                                                    {{ $vendor->name }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    <label for="username" class="form-label">@lang('admin.warehouses.name') -@lang('language.'.$locale)
                                                        <span class="text-danger">*</span>
                                                    </label>
