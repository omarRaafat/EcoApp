        ...
        <div class="col-lg-12">
            <div class="card" id="orderList">
                ...
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('admin.recipe.store') }}" method="post" class="form-steps"
                                                ...
                                                <div class="col-md-3 mb-3">
                                                  ...
                                                  <div class="col-lg-3 mb-3">
                                                    ...
                                                    <textarea name="short_desc[{{$locale}}]" class="form-control @error('short_desc.'.$locale) is-invalid @enderror" name="short_desc[{{ $locale }}]"
                                                        placeholder="@lang('admin.recipes.short_desc')-@lang('language.'.$locale)"> {{ old('short_desc.'.$locale)}}</textarea>
                                                ...
                                                <div class="col-lg-3" style="padding-top: 30px">
                                                    <div class="mb-3">
                                                        <div class="form-check form-switch form-switch-lg" dir="rtl">
                                                            @if(old("most_visited") == "on")
                                                                <input checked type="checkbox" name="most_visited" class="form-check-input" id="most_visited">
                                                            @else
                                                                <input type="checkbox"  name="most_visited" class="form-check-input" id="most_visited">
                                                            @endif
                                                            <label class="form-check-label" for="most_visited">@lang('admin.recipes.most_visited')</label>
                                                        </div>
                                                        @error('most_visited')
                                                            <span class="text-danger">{{ $message }}</span>
                                                        @enderror
