            ...
            <div class="card" id="cities">
                <div class="card-header  border-0">
                    <div class="d-flex align-items-center">
                        <h5 class="card-title mb-0 flex-grow-1">@lang('admin.cities.manage_cities')</h5>
                        <div class="flex-shrink-0">
                            <div class="d-flex gap-1 flex-wrap">
                                <a href="{{ route("admin.cities.create") }}" class="btn btn-primary add-btn" id="create-btn">
                                    <i class="ri-add-line align-bottom me-1"></i>  @lang("admin.cities.create")
                                </a>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-xxl-3 col-sm-6">
                                <div class="search-box">
                                    <input name="search" type="text" class="form-control search"
                                           placeholder="@lang("admin.cities.search")">
                            ...
                            <div class="col-xxl-3 col-sm-6">
                                <div>
                                    <select name="trans" class="form-control" data-choices data-choices-search-false  id="idStatus">
                                        ...
                                        <option value="ar">@lang("admin.cities.name_ar")</option>
                                    </select>
                                </div>
                            </div>
                            <!--end col-->
                            <div class="col-xxl-2 col-sm-4">
                                <div>
                                    <select name="is_active" class="form-control" data-choices data-choices-search-false  id="idStatus">
                                        <option value="all" selected>@lang("admin.cities.filter_is_active")</option>
                                        <option value="1">@lang("admin.cities.active")</option>
                                        <option value="0">@lang("admin.cities.inactive")</option>
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="table-responsive table-card mb-1">
                            <table class="table table-nowrap align-middle" id="citiesTable">
                                ...
                                <tr class="text-uppercase">
                                    ...
                                    <th>@lang('admin.cities.area_id')</th>
                                    <th>@lang('admin.cities.is_active')</th>
                                    <th>@lang('admin.cities.torod_city_id')</th>
                                    ...
                                    @if ($cities->count() > 0)
                                        @foreach($cities as $city)
                                            <tr>
                                                ...
                                                <td class="name_en">{{ $city->getTranslation('name', 'ar') }}</td>
                                                <td class="name_en">{{ $city->getTranslation('name', 'en') }}</td>
                                                <td class="area_id">{{ !empty($city->area) ? $city->area->getTranslation('name', 'ar') : trans("admin.cities.not_found") }}</td>
                                                <td class="is_active">
                                                ...
                                                <td class="area_id">{{ !empty($city->torod_city_id) ? $city->torod_city_id : trans("admin.cities.not_found") }}</td>
                                                <td class="spl_id">{{ $city->spl_id ? $city->spl_id : trans("admin.not_found") }}</td>
                                                <td>
                                                    <ul class="list-inline hstack gap-2 mb-0">
                                                        ...
                                                        <li class="list-inline-item" data-bs-toggle="tooltip"
                                                            data-bs-trigger="hover" data-bs-placement="top" title="@lang('admin.cities.edit')">
                                                        ...
                                                        <li class="list-inline-item" data-bs-toggle="tooltip"
                                                            ...
                                                            data-bs-toggle="modal" href="#deletecity-{{$city->id}}">
                                            ...
                                            <!-- Start Delete Modal -->
                                            <div class="modal fade flip" id="deletecity-{{$city->id}}" tabindex="-1" aria-hidden="true">
                                                    ...
                                                    <div class="modal-content">
                                                        <div class="modal-body p-5 text-center">
                                                            ...
                                                            <div class="mt-4 text-center">
                                                                <h4>@lang('admin.cities.delete_modal.title')</h4>
                                                                <p class="text-muted fs-15 mb-4">@lang('admin.cities.delete_modal.description')</p>
                    ...
                    <!-- End Delete Modal -->
                        <div class="noresult" style="display: none">
                            <div class="text-center">
                                    ...
                                    <h5 class="mt-2">@lang('admin.cities.no_result_found')</h5>
                                </div>
                            </div>
                        </div>
