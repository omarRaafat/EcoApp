                    ...
                    <table id="example" class="table table-bordered dt-responsive nowrap table-striped align-middle" style="width:100%">
                        <thead>
                            <tr>
                                ...
                                <th scope="col">@lang('admin.cart_services_count')</th>
                        ...
                        <tbody>
                            @foreach ($carts as $cart)
                                <tr>
                                    ...
                                    <td>{{ $cart->cart_service_total .' '. __('translation.sar') }}</td>
                                    <td>{{ $cart->services->count() }}</td>
                                    <td>{{ date('d-m-Y h:i', strtotime($cart->created_at)) }}</td>
                                    <td>
                                        <div class="hstack gap-3 flex-wrap">
                                            <a href="{{ route('admin.service_carts.show', ['cart' => $cart]) }}" class="fs-15">
                                                <i class="ri-eye-line"></i>
                                            </a>
                                            <a href="{{ route('admin.service_carts.delete', ['cart' => $cart]) }}" class="fs-15 link-danger">
