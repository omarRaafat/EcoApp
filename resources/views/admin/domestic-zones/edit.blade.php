        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">@lang('admin.delivery.domestic-zones.edit-title')</h4>
                </div><!-- end card header -->
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.domestic-zones.update', ['domestic_zone' => $domesticZone->id]) }}">
                        @csrf
                        @method('put')
                        <div class="row gy-4">
