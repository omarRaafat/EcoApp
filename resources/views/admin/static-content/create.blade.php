        ...
        <div class="col-lg-12">
            <div class="card" id="orderList">
                ...
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route($routeBase. '.store') }}" method="post" class="form-steps" autocomplete="on">
                                @csrf
                                @method('post')
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea type="text" name="paragraph[{{ $locale }}]" class="ckeditor form-control
                                                            ...
                                                            placeholder="@lang($translateBase. '.paragraph')">{{ old('paragraph.'.$locale) }}</textarea>
