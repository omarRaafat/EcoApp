                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-shrink-0">
                            <div class="d-flex gap-1 flex-wrap">
                                <a href="{{ route('admin.post-harvest-services-departments.create') }}"
                                    class="btn btn-primary add-btn" id="create-btn">
                                    <i class="ri-add-line align-bottom me-1"></i> @lang('postHarvestServices.create')
                                </a>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-xxl-3 col-sm-6">
                                <div>
                                    <select name="status" class="form-control" data-choices data-choices-search-false
                                        ...
                                        <option value="active">@lang('postHarvestServices.status_fields.active')</option>
                                        <option value="not_active">@lang('postHarvestServices.status_fields.not_active')</option>
                                    </select>
                                </div>
                            </div>
                                    ...
                                    @if ($data->count() > 0)
                                        @foreach ($data as $index => $item)
                                            <tr>
                                                ...
                                                <td>
                                                    <img width="100"
                                                        src="{{ $item->image == null ? asset('images/Mouzare_Logo.png') : asset('storage/uploads/postHarvestServicesDepartment/' . $item->image) }}"
                                                        alt="{{ $item->name }}">
                                                </td>
                                                <td>
                                                    <span
                                                ...
                                                <td>
                                                    <a href="{{ route('admin.post-harvest-services-departments.fields', $item->id) }}"
                                                ...
                                                <td>
                                                    <ul class="list-inline hstack gap-2 mb-0">
                                                        <li class="list-inline-item" data-bs-toggle="tooltip"
                                                            ...
                                                            <a href="{{ route('admin.post-harvest-services-departments.show', $item->id) }}"
                                                        ...
                                                        <li class="list-inline-item" data-bs-toggle="tooltip"
                                                            ...
                                                            <a href="{{ route('admin.post-harvest-services-departments.edit', $item->id) }}"
                                                                class="text-primary d-inline-block">
                                                                        ...
                                                                        <div class="modal-body p-5 text-center">
                                                                            ...
                                                                            <div class="mt-4 text-center">
                                                                                ...
                                                                                <div
                                                                                    ...
                                                                                    <form
                                                                                        action="{{ route('admin.post-harvest-services-departments.destroy', $item->id) }}"
                                                                                        method="post">
                                                                                        @csrf
                                                                                        @method('DELETE')
                                                                                        <button type="submit"
