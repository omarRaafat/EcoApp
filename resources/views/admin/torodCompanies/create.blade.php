...
@section('title')
    @lang('admin.torodCompanies.create')
@endsection
@section('css')
        ...
        <div class="col-lg-12">
            <div class="card" id="orderList">
                ...
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('admin.torodCompanies.store') }}" method="post" class="form-steps" autocomplete="on" enctype="multipart/form-data">
                                @csrf
                                @method('post')
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea class="form-control" name="desc_ar" id="desc_ar" rows="6" placeholder="{{ trans('admin.torodCompanies.desc_ar') }}">{{ old("desc_ar") }}</textarea>
                                                        @error('desc_ar')
                                                            <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea class="form-control" name="desc_en" id="desc_en" rows="6" placeholder="{{ trans('admin.torodCompanies.desc_en') }}">{{ old("desc_en") }}</textarea>
                                                        @error('desc_en')
                                                            <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                                ...
                                                <div class="col-lg-3">
                                                    <div class="mb-3">
                                                        <div class="form-check form-switch form-switch-lg" dir="ltr">
                                                            <input name="active_status" {{ old("active_status") ? "checked" : "" }} type="checkbox" class="form-check-input" id="customSwitchsizelg">
