        ...
        <div class="col-lg-12">
            <div class="card" id="orderList">
                ...
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('admin.palm-lengths.store') }}" method="post" class="form-steps" autocomplete="on">
                                @csrf
                                @method('post')
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane fade active show" id="palm-lengths-arabic-info" role="tabpanel" aria-labelledby="palm-lengths-arabic-info-tab">
                                        <div>
                                            <div class="row">
