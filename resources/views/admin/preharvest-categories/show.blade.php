                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="flex-shrink-0">
                                                <div class="d-flex gap-1 flex-wrap">
                                                    <a href="{{ route("admin.preharvest-categories.createSubCategory", ["parent_id" => $category->id]) }}" class="btn btn-primary add-btn" id="create-btn">
                                            ...
                                            <div class="table-responsive table-card mb-1">
                                                <table class="table table-nowrap align-middle" id="citiesTable">
                                                    ...
                                                    @foreach($category->child as $subcategory)
                                                        <tr>
                                                            <td class="id">
                                                                <a href="{{ route("admin.preharvest-categories.showSubCategory", ["id" => $subcategory->id]) }}" class="fw-medium link-primary">
                                                                    #{{$subcategory->id}}
                                                                </a>
                                                            </td>
                                                            ...
                                                            @if($subcategory->type != 3)
                                                                <td>{{ $subcategory->SubCategoriesCount() }}</td>
                                                            @endif
                                                            <td class="is_active">
                                                            ...
                                                            <td>
                                                                <ul class="list-inline hstack gap-2 mb-0">
                                                                    <li class="list-inline-item" data-bs-toggle="tooltip"
                                                                        ...
                                                                        <a href="{{ route("admin.preharvest-categories.showSubCategory", ["id" => $subcategory->id]) }}"
                                                                    ...
                                                                    <li class="list-inline-item" data-bs-toggle="tooltip"
                                                                        ...
                                                                        <a href="{{ route("admin.preharvest-categories.editSubCategory", ["id" => $subcategory->id]) }}"
                                                                           class="text-primary d-inline-block">
                                                                    ...
                                                                    <li class="list-inline-item" data-bs-toggle="tooltip"
                                                                        ...
                                                                        <a class="text-danger d-inline-block remove-item-btn"
                                                                           data-bs-toggle="modal" href="#deleteCategory-{{ $subcategory->getUniqueIdentifier() }}">
                                                                            <i class="ri-delete-bin-5-fill fs-16"></i>
                                                                        </a>
                                                                        <!-- Start Delete Modal -->
                                                                        <div class="modal fade flip" id="deleteCategory-{{ $subcategory->getUniqueIdentifier() }}" tabindex="-1" aria-hidden="true">
                                                                                    ...
                                                                                    <div class="modal-body p-5 text-center">
                                                                                        ...
                                                                                        <div class="mt-4 text-center">
                                                                                            ...
                                                                                            <div class="hstack gap-2 justify-content-center remove">
                                                                                                ...
                                                                                                <form action="{{ route("admin.preharvest-categories.destroy", $subcategory->id) }}" method="post">
                                                                                                    @csrf
                                                                                                    @method("DELETE")
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body pt-0">
                                        <form action="javascript:void(0);" class="row g-3">
                                            ...
                                            <div class="col-md-6">
                                                <label for="username" class="form-label">@lang("admin.categories.name_en")</label>
                                                <input disabled="disabled" readonly type="text" class="form-control" value="{{ $category->getTranslation('name', 'en') }}">
                                            </div>
                                            <div class="col-md-6">
                                            ...
                                            @if($category->level != 1)
                                                ...
                                                <div class="col-md-6">
                                                    <label for="username" class="form-label">@lang("admin.categories.parent_name_en")</label>
                                                    <input disabled="disabled" readonly type="text" class="form-control" value="{{ $category->parent_category_name_en != 0 ? $category->parent_category_name_en : trans('admin.categories.not_found') }}">
                                                </div>
                                                <div class="col-md-6">
