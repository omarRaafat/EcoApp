        ...
        <div class="col-lg-12">
            <div class="card" id="categories">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-shrink-0">
                            <div class="d-flex gap-1 flex-wrap">
                                <a href="{{ route("admin.preharvest-categories.create") }}" class="btn btn-primary add-btn"
                                   id="create-btn">
                ...
                <div class="card-body border border-dashed border-end-0 border-start-0">
                    <form action="{{ route("admin.preharvest-categories.index") }}">
                        <div class="row g-3">
                            <div class="col-xxl-2 col-sm-4">
                                <div class="search-box">
                                    <input name="search" type="text" class="form-control search" value="{{ request()->get('search') }}" placeholder="@lang("admin.categories.search")">
                            ...
                            <div class="col-xxl-2 col-sm-4">
                                <div>
                                    <select class="form-control" data-choices data-choices-search-false name="is_active" id="is_active">
                ...
                <div class="card-body pt-0">
                    <div>
                        <ul class="nav nav-tabs nav-tabs-custom nav-primary mb-3" role="tablist">
                            <li class="nav-item">
                                <a href="{{ route('admin.preharvest-categories.index') }}" class="nav-link py-3 {{ empty(request()->query()) ? 'active' : '' }}"
                                     id="active">
                                     <i class="ri-store-2-fill me-1 align-bottom"></i> @lang('admin.categories.all_categories')
                                 </a>
                            </li>
                            <li class="nav-item">
                                <form action="{{ route("admin.preharvest-categories.index") }}" method="get">
                                    <input type="hidden" name="is_active" value="1">
                                    <button type="submit" class="nav-link py-3 {{ request()->has("is_active") && request()->is_active ==  1 ? 'active' : '' }}"
                        ...
                        <div class="table-responsive table-card mb-1">
                            <table class="table table-nowrap align-middle" id="categoriesTable">
                                ...
                                @foreach($categories as $category)
                                    <tr data-id="{{ $category->id }}" data-order="{{$category->order}}">
                                        ...
                                        <td>
                                            <a href="{{ route("admin.preharvest-categories.show", ["id" => $category->id, "type" => 1]) }}" class="fw-medium link-primary">
                                                #{{$category->id}}
                                            </a>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <ul class="list-inline hstack gap-2 mb-0">
                                                <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="@lang('admin.categories.show')">
                                                    <a href="{{ route("admin.preharvest-categories.show", $category->id) }}"
                                                       class="text-primary d-inline-block">
                                                        <i class="ri-eye-fill fs-16"></i>
                                                    </a>
                                                </li>
                                                <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="@lang('admin.categories.edit')">
                                                    <a href="{{ route("admin.preharvest-categories.edit", $category->id) }}" class="text-primary d-inline-block">
                                                        <i class="ri-edit-2-line"></i>
                                                    </a>
                                                </li>
                                                <li class="list-inline-item" data-bs-toggle="tooltip"
                                                    data-bs-trigger="hover" data-bs-placement="top" title="Remove">
                                                    <a class="text-danger d-inline-block remove-item-btn" data-bs-toggle="modal" href="#deleteCategory-{{ $category->getUniqueIdentifier() }}">
                                                                ...
                                                                <div class="modal-body p-5 text-center">
                                                                    ...
                                                                    <div class="mt-4 text-center">
                                                                        ...
                                                                        <div class="hstack gap-2 justify-content-center remove">
                                                                            ...
                                                                            <form action="{{ route("admin.preharvest-categories.destroy", $category->id) }}"
                                                                                  method="post">
                                                                                @csrf
                                                                                @method("DELETE")
                                                                                <button type="submit"
                            ...
                            <div class="noresult" style="display: none">
                                <div class="text-center">
                                    <lord-icon src="https://cdn.lordicon.com/msoeawqm.json" trigger="loop" colors="primary:#25a0e2,secondary:#0ab39c" style="width:75px;height:75px"></lord-icon>
                    ...
                    $(this).find("tr").each(function (index) {
                        ...
                        data.forEach(function (item) {
                            if(index == item.index)
                            {
                                ...
                                $("tr[data-id='" + id + "']").attr('data-order',item.order);
                                $("tr[data-id='" + id + "']").find("td").eq(6).html(item.order);
                            }
                        });
                    });
                    $.post("{{ route('admin.preharvest-categories.updateCategoryOrder') }}", {
                        "data": newData,
                        "_token": "{{ csrf_token() }}"
                    }, function (data) {
                    },'json');
