        ...
        <div class="col-lg-12">
            <div class="card" id="orderList">
                ...
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('admin.slider.store') }}" method="post" class="form-steps" autocomplete="on" enctype="multipart/form-data">
                                @csrf
                                @method('post')
                                <div class="row">
                                    <div class="col-lg-6">
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            placeholder="{{ trans('admin.sliders.url') }}" value="{{ old('url') }}">
                                            @error('url')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            placeholder="{{ trans('admin.sliders.identifier') }}" value="{{ old('identifier') }}">
                                            @error('identifier')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
