<div class="row">
    <div class="col-lg-8">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="mb-3" >
                    <label for="choices-publish-status-input" class="form-label">@lang('translation.main_category')<span class="required" style="color: red!important">*</span></label>
                ...
                <div class="mb-3">
                    <label for="choices-publish-status-input" class="form-label">@lang('admin.products.vendor')<span class="required" style="color: red!important">*</span></label>
                    <select @if(!isset($row) || $row->vendor->is_international != 1) onchange="vendorChange(this)" @endif class="form-select" name="vendor_id" id="main-choices-input-vendor_id" >
                        <option value="">@lang('admin.products.vendor')</option>
                        @foreach($vendors AS $vendor)
                            <option data-international="{{ $vendor->is_international }}" @if((isset($row) && $row->vendor_id == $vendor->id) || old('vendor_id') == $vendor->id) selected @endif value="{{ $vendor->id }}">{{ $vendor->name }}</option>
                        @endforeach
                    </select>
                    @error('vendor_id')
                        <span class="error text-danger"> {{ $message }} </span>
        ...
        <div class="card card-{{$locale}}">
            <div class="card-body">
                <div class="mb-3">
                    <div class="mb-3">
                        <label class="form-label" for="product-name-inputs">@lang('translation.product_name')<span class="required" style="color: red!important">*</span> (@lang('language.'.$locale))</label>
                ...
                <div>
                    ...
                    <label>@lang('translation.product_desc')-(@lang('language.'.$locale))<span class="required" style="color: red!important">*</span></label>
                    @error('desc.'.$locale)
                    <span class="error text-danger"> {{ $message }} </span>
                    @enderror
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="mb-4">
                    <h5 class="fs-14 mb-1">@lang('translation.product_image')<span class="required" style="color: red!important">*</span></h5>
    ...
    <div class="col-lg-4">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-12 col-sm-6">
                        <div class="mb-4">
                            <label class="form-label" for="manufacturer-name-input">@lang('translation.total_weight') @lang('translation.gram')<span class="required" style="color: red!important">*</span></label>
                    ...
                    <div class="col-lg-6 col-sm-6">
                        <div class="mb-2">
                            <label class="form-label" for="manufacturer-name-input">@lang('translation.net_weight') @lang('translation.gram')<span class="required" style="color: red!important">*</span></label>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div>
                    <label for="choices-publish-visibility-input" class="form-label">@lang('translation.is_active') (الإدارة) </label>

                    {{ Form::select('is_active', ['0' => __('translation.hidden'), '1' => __('translation.visible')], null, ['class'=>'form-select','id'=>'choices-publish-visibility-input','data-choices' ]) }}
                    @error('is_active')
                        <span class="error text-danger"> {{ $message }} </span>
                    @enderror
                </div>
                <div>
                    <label for="choices-publish-visibility-input" class="form-label">@lang('translation.is_active') (البائع)</label>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-4 col-sm-4 text-center">
                        <a href="{{ route('admin.products.prices.create',['id' => $row->id]) }}" class="btn btn-primary">
                            <i class="ri-add-line align-bottom me-1"></i>  @lang('admin.add')
                        </a>
                    </div>
                    <div class="col-lg-8 col-sm-8 text-center">
                        <a href="{{ route('admin.products.prices.list',['id' => $row->id]) }}"  class="btn btn-primary">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-6 col-sm-6">
                        <div class="mb-3">
                            <label class="form-label" for="product-price-input">@lang('translation.price') @lang('translation.sar')<span class="required" style="color: red!important">*</span></label>
        ...
        <div class="card ">
            ...
            <div class="card-body">
                ...
                <div class="mb-3" style="margin-top: 10px;">
                    <label for="choices-publish-status-input" class="form-label">@lang('translation.quantity_type')<span class="required" style="color: red!important">*</span></label>
                ...
                <div class="mb-3" style="margin-top: 10px;">
                    <label for="choices-publish-status-input" class="form-label">@lang('translation.sku')</label>
                    {{ Form::text('sku', $row->sku ?? old('sku'), ['class'=>'form-control','id'=>'sku-input','placeholder'=> __('translation.sku_placeholder'),'aria-label'=>'Stock','aria-describedby'=>'product-sku-addon']) }}
                    @error('sku')
                        <span class="error text-danger"> {{ $message }} </span>
                    @enderror
                </div>
                ...
                <div lass="mb-3 mt-2">
                    ...
                    @enderror
                    @if(isset($row) && $row->clearance_cert_media)
        ...
        {{-- <div class="card">
            ...
            <div class="card-body">
                <div>
                    <label for="datepicker-publish-input" class="form-label">@lang('translation.product_expire_date')<span class="required" style="color: red!important">*</span></label>
...
<script>
    ...
    {
        if (!ele.val()) return
        $.get('/admin/get-category-by-parent-id?parent_id='+ele.val()+'&level='+level,(response)=>{
