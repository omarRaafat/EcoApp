        ...
        <div class="col-lg-12">
            <div class="card" id="orderList">
                ...
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('admin.stages.update', $stage->id) }}" method="post" class="form-steps" autocomplete="on">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane fade active show" id="stages-arabic-info" role="tabpanel"
                                        aria-labelledby="stages-arabic-info-tab">
                                        <div>
                                            <div class="row">
                                                @foreach(config('app.locales') AS $locale)
                                                <div class="col-md-6 mb-3">
                                                    <label for="username" class="form-label">@lang('admin.stages.name') -@lang('language.'.$locale)
                                                        <span class="text-danger">*</span>
                                                    </label>
                                                    <input type="text" class="form-control @error('name.'.$locale) is-invalid @enderror" name="name[{{ $locale }}]"
                                                    value="{{ old('name.'.$locale) ?? $stage->getTranslation('name',$locale)}}"
                                                    id="stage_name">
                                                    @error('name.' . $locale)
                                            ...
                                            {{-- <div class="row">
                                                    <div class="col-md-6 mb-3">
                                                        <label for="username" class="form-label">@lang('admin.stages.name') -@lang('language.en')
                                                            <span class="text-danger">*</span>
                                                        </label>
                                                        <input type="text" class="form-control @error('name.en') is-invalid @enderror" name="name[en]"
                                                               value="{{ old('name.en') ?? $stage->getTranslation('name','en')}}"
                                                               id="stage_name">
                                                        @error('name.en')
                                                        <span class="invalid-feedback" role="alert">
                                                        <strong>
                                               ...
                                               <div class="row">
                                                <div class="col-md-2 mb-3">
                                                    <label class="form-label" for="is_active">@lang('admin.stages.is_active')</label>
                                                    <div class="form-check form-switch form-switch-lg" dir="ltr">
                                                        @if($stage->is_active == true)
...
@section('script')
    ...
    <script type="text/javascript">
        ...
        var warehouseLat = {{!empty($stage->latitude) ? $stage->latitude : 24.7251918}}
            var warehouseLong = {{!empty($stage->longitude) ? $stage->longitude : 46.8225288 }}
