        ...
        <div class="col-lg-12">
            <div class="card" id="orderList">
                ...
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('admin.stages.store') }}" method="post" class="form-steps" autocomplete="on">
                                @csrf
                                @method('post')
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane fade active show" id="stages-arabic-info" role="tabpanel" aria-labelledby="stages-arabic-info-tab">
                                        <div>
                                            <div class="row">
