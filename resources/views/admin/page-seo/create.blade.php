            ...
            <div class="card" id="productClasses">
                <div class="card-header  border-0">
                    <div class="d-flex align-items-center">
                        <h5 class="card-title mb-0 flex-grow-1">@lang('page-seo.create')</h5>
                    </div>
                </div>
                <div class="card-body">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <select name="page" class="form-select" dir="rtl" data-choices data-choices-removeItem>
                                    ...
                                    <option value='{{ $page }}' @selected(old('page') == $page)>
                                        {{ $page }}
                                    </option>
                                    @endforeach
                                </select>
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <textarea name="tags[{{ $locale }}]" class="form-control"
                                            placeholder="">{{ old("tags[$locale]") }}</textarea>
                                        @error("tags.$locale")
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <textarea name="description[{{ $locale }}]" class="form-control"
                                            placeholder="">{{ old("description[$locale]") }}</textarea>
