                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="flex-shrink-0">
                                                <div class="d-flex gap-1 flex-wrap">
                                                    <a href="{{ route("admin.categories.createSubCategory", ["parent_id" => $category->id]) }}" class="btn btn-primary add-btn" id="create-btn">
                                            ...
                                            <div class="table-responsive table-card mb-1">
                                                <table class="table table-nowrap align-middle" id="citiesTable">
                                                    ...
                                                    @foreach($category->child as $subcategory)
                                                        <tr>
                                                            <td class="id">
                                                                <a href="{{ route("admin.categories.showSubCategory", ["id" => $subcategory->id]) }}" class="fw-medium link-primary">
                                                                    #{{$subcategory->id}}
                                                                </a>
                                                            </td>
                                                            ...
                                                            <td>
                                                                <ul class="list-inline hstack gap-2 mb-0">
                                                                    <li class="list-inline-item" data-bs-toggle="tooltip"
                                                                        ...
                                                                        <a href="{{ route("admin.categories.showSubCategory", ["id" => $subcategory->id]) }}"
                                                                    ...
                                                                    <li class="list-inline-item" data-bs-toggle="tooltip"
                                                                        ...
                                                                        <a href="{{ route("admin.categories.editSubCategory", ["id" => $subcategory->id]) }}"
                                                                           class="text-primary d-inline-block">
