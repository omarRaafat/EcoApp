                                ...
                                <div class="tab-content">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 mb-3">
                                            ...
                                            value="{{ old('title.'.$locale) ?? $blogPost->getTranslation('title',$locale)}}"
                                          ...
                                          <div class="col-lg-3 mb-3">
                                            ...
                                            <textarea name="short_desc[{{$locale}}]" class="form-control @error('short_desc.'.$locale) is-invalid @enderror" name="short_desc[{{ $locale }}]"
                                                placeholder="@lang('admin.blogPosts.short_desc')-@lang('language.'.$locale)"> {{ old('short_desc.'.$locale) ?? $blogPost->getTranslation('short_desc',$locale)}}</textarea>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                <label class="form-label"
                                                    for="body[{{ $locale }}]">@lang('admin.blogPosts.body')-@lang('language.'.$locale)</label>
                                                <textarea type="text" name="body[{{ $locale }}]" class="ckeditor form-control"
                                                    id="body{{$locale}}" rows="5"
                                                    placeholder="@lang('qnas.blogPosts.body')">{!! old('body.'.$locale) ?? $blogPost->getTranslation('body',$locale) !!}</textarea>
                                                @error('body.'.$locale)
                                                <span class="error text-danger" role="alert"> {{ $message }} </span>
                                                @enderror
                                            </div>
                                        ...
                                        {{-- <div class="col-lg-3" style="padding-top: 30px">
                                            <div class="mb-3">
                                                <div class="form-check form-switch form-switch-lg" dir="rtl">
                                                    <input type="checkbox" {{ $blogPost->most_visited == true ? "checked" : false }} name="most_visited" class="form-check-input" id="most_visited">
                                                    <label class="form-check-label" true-value="true" for="most_visited">@lang('admin.blogPosts.most_visited')</label>
                                                </div>
                                                @error('most_visited')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
