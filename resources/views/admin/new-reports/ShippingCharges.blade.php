...
@section('title')
    @lang('admin.reports.ShippingCharges')
@endsection
@section('css')
    ...
    <div class="col-lg-12">
        <div class="card" id="reports">
            <div class="card-body border border-dashed border-end-0 border-start-0">
                <form action="{{ route("admin.reports.ShippingCharges") }}">
                    <div class="row g-3">
                        ...
                        <div class="col-xxl-1 col-sm-4">
                            <div>
                                <a href="{{route('admin.reports.ShippingCharges')}}" class="btn btn-info w-100"><i
                                        class="ri-equalizer-fill me-1 align-bottom"></i>
            ...
            <div class="card-body border border-dashed border-end-0 border-start-0">
                <div class="col-md-3 float-right">
                    <a href="{{ route('admin.reports.ShippingCharges' , ['export_excel'=>true, 'from' => request()->get('from') , 'to' => request()->get('to') ]) }}" class="btn btn-primary">تصدير Excel</a>
                </div>
            </div>
            <div class="card-body">
                <div>
