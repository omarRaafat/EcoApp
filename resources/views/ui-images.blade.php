                ...
                <div class="card-body">
                    ...
                    <div class="live-preview">
                        ...
                        <div class="row align-items-center">
                            <div class="col-6">
                                <img class="rounded" alt="200x200" width="200" src="{{ URL::asset('assets/images/small/img-4.jpg') }}"
                        ...
                        <div class="row g-3">
                            <div class="col-sm-6">
                                <figure class="figure mb-0">
                                    <img src="{{ URL::asset('assets/images/small/img-4.jpg') }}" class="figure-img img-fluid rounded"
                                        alt="...">
                            ...
                            <div class="col-sm-6">
                                <figure class="figure mb-0">
                                    <img src="{{ URL::asset('assets/images/small/img-5.jpg') }}" class="figure-img img-fluid rounded"
                                        alt="...">
