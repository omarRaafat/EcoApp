                    ...
                    <div class="swiper-slide">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-center">
                                    <img src="{{ URL::asset('assets/images/svg/crypto-icons/mkr.svg') }}"
                                        class="bg-light rounded-circle p-1 avatar-xs img-fluid" alt="">
        ...
        <div class="col-xxl-3">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div>
                        <a href="{{URL::asset('/apps-crypto-transactions')}}" class="btn btn-soft-primary w-100">View All Transactions <i
