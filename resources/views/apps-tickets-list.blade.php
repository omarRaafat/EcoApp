    ...
    <div class="col-lg-12">
        <div class="card" id="ticketsList">
            ...
            <div class="card-body">
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end">
                                            ...
                                            <li><a class="dropdown-item edit-item-btn" href="#showModal" data-bs-toggle="modal"><i class="ri-pencil-fill align-bottom me-2 text-muted"></i>
                                                    Edit</a></li>
                                            <li>
                                                <a class="dropdown-item remove-item-btn" data-bs-toggle="modal" href="#deleteOrder-{{$order->id}}">
                ...
                <!-- Modal -->
                <div class="modal fade flip" id="deleteOrder-{{$order->id}}" tabindex="-1" aria-hidden="true">
