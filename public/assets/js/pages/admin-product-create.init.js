...
(function () {
    ...
    // Fetch all the forms we want to apply custom Bootstrap vadmin-product-create.initalidation styles to
    ...
    Array.prototype.slice.call(forms)
        .forEach(function (form) {
            form.addEventListener('submit', function (event) {
                ...
                var test = $('#desc-hiddens_ar').val($('.card-ar .ck-editor__editable_inline').html())
