...
function confirmAccept(event){
    ...
    swalWithBootstrapButtons.fire({
        html: '<div class="mt-3">' +
            '<lord-icon src="https://cdn.lordicon.com/ozmbktct.json" trigger="loop" style="width:100px;height:100px"></lord-icon>' +
            '<div class="mt-4 pt-2 fs-15 mx-5">' +
            '<h4> هل انت متأكد ؟ </h4>' +
            '<p class="text-muted mx-4 mb-0">تريد الموافقة هذا العنصر  !</p>' +
            '</div>' +
            '</div>',
        showCancelButton: true,
        confirmButtonClass: 'btn btn-success w-xs me-2 mb-1',
        confirmButtonText: 'نعم , تأكيد الموافقة!',
        cancelButtonText: 'لا , إغلاق',
        cancelButtonClass: 'btn btn-secondary mx-2 w-xs mb-1',
...
function confirmReject(event){
    ...
    swalWithBootstrapButtons.fire({
        html: '<div class="mt-3">' +
            ...
            '<div class="mt-4 pt-2 fs-15 mx-5">' +
            '<h4> هل انت متأكد ؟ </h4>' +
            '<p class="text-muted mx-4 mb-0">تريد رفض هذا العنصر  !</p>' +
            '</div>' +
            '</div>',
        showCancelButton: true,
        confirmButtonClass: 'btn btn-success w-xs me-2 mb-1',
